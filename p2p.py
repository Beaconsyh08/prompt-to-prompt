...
def run_and_display(prompts, controller, latent=None, run_baseline=False, generator=None,save_path='./image.jpg'):
    if run_baseline:
...
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=True,save_path='replace.jpg')
...
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=False,save_path='replace2.jpg')
...
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=False,save_path='localedit.jpg')
...
controller = AttentionReplace(prompts, NUM_DIFFUSION_STEPS,
                              ...
                              self_replace_steps=0.4,
                              local_blend=lb)
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=True,save_path='localedit.jpg')
...
_ = run_and_display(prompts, controller, latent=x_t,save_path='refine.jpg')
...
_ = run_and_display(prompts, controller, latent=x_t,save_path='refine2.jpg')
...
controller = AttentionRefine(prompts, NUM_DIFFUSION_STEPS, cross_replace_steps=.8,
                             self_replace_steps=.4)
_ = run_and_display(prompts, controller, latent=x_t,save_path='refine3.jpg')
...
controller = AttentionReweight(prompts, NUM_DIFFUSION_STEPS, cross_replace_steps=.8,
                               self_replace_steps=.4,
                               equalizer=equalizer)
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=False,save_path='reweight.jpg')
...
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=False,save_path='mix.jpg')
...
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=False,save_path='mix2.jpg')
...
controller = AttentionRefine(prompts, NUM_DIFFUSION_STEPS, cross_replace_steps=.8,
                             self_replace_steps=.4, local_blend=lb)
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=False,save_path='mix3.jpg')
...
controller = AttentionReweight(prompts, NUM_DIFFUSION_STEPS, cross_replace_steps=.8,
                               self_replace_steps=.4, equalizer=equalizer, local_blend=lb,
                               controller=controller_a)
_ = run_and_display(prompts, controller, latent=x_t, run_baseline=False,save_path='mix4.jpg')